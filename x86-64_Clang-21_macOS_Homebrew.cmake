#
# Toolchain: x86-64 with Clang 21
# Installed: From Homebrew (brew install llvm@21)
# Host Mach: macOS
#
set(CMAKE_C_COMPILER                /usr/local/opt/llvm@21/bin/clang)
set(CMAKE_CXX_COMPILER              /usr/local/opt/llvm@21/bin/clang++)
set(LLVM_PROFDATA                   /usr/local/opt/llvm@21/bin/llvm-profdata)
set(LLVM_COV                        /usr/local/opt/llvm@21/bin/llvm-cov)
...
if (CHAOS_USE_BUNDLED_LIBCPP)
    ...
    set(CMAKE_EXE_LINKER_FLAGS "-L/usr/local/opt/llvm@21/lib/c++ -L/usr/local/opt/llvm@21/lib/unwind -lunwind")
endif()
