#
# Toolchain: x86-64 with Clang 22
# Installed: From Homebrew (brew install llvm@22)
# Host Mach: macOS
#
set(CMAKE_C_COMPILER                /usr/local/opt/llvm@22/bin/clang)
set(CMAKE_CXX_COMPILER              /usr/local/opt/llvm@22/bin/clang++)
set(LLVM_PROFDATA                   /usr/local/opt/llvm@22/bin/llvm-profdata)
set(LLVM_COV                        /usr/local/opt/llvm@22/bin/llvm-cov)
...
if (CHAOS_USE_BUNDLED_LIBCPP)
    ...
    set(CMAKE_EXE_LINKER_FLAGS "-L/usr/local/opt/llvm@22/lib/c++ -L/usr/local/opt/llvm@22/lib/unwind -lunwind")
endif()
